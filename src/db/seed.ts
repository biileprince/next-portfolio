  ...
  await db.insert(projects).values([
    {
      ...
      description:
        "A comprehensive web application developed for Sasakawa Restaurant that streamlines catering requests, approvals, invoicing, and financial tracking with role-based workflow automation. Completed July 2025.",
      ...
      features: JSON.stringify([
        "Role-based workflow for Requesters, Approvers, and Finance officers",
        "Digital request lifecycle from submission through approval, invoicing, and payment",
        "Request submission with event details and supporting document upload",
        "Dedicated approval queue with approve/reject actions and review comments",
        "Invoice generation and payment recording with financial tracking",
        "Automated email notifications with resilient delivery strategy",
        "Financial reporting and export-ready operational summaries",
        "Audit-friendly visibility and institutional compliance trail",
      ]),
      githubUrl: "#",
    ...
    },
    {
      ...
      features: JSON.stringify([
        ...
        "Secure JWT-based authentication with role-specific access",
        "Production deployment improvements for SSR and Prisma 7 migration",
        "Environment-aware API routing for server-side data fetching",
        "Responsive mobile-first UX with optimized mobile navigation",
      ]),
      githubUrl: "#",
    ...
    },
    {
      ...
      features: JSON.stringify([
        ...
        "Campus-first marketplace experience for students and local sellers",
        "Merchant-ready foundations for growth beyond campus users",
      ]),
    ...
    },
    {
      ...
      features: JSON.stringify([
        ...
        "File uploads via Cloudinary for resumes and company documents",
    ...
    },
    {
      ...
      features: JSON.stringify([
        ...
        "Email notifications for referral events and reward actions",
        "Google OAuth login integration",
        "Password recovery workflow",
        "User profile management",
        "Admin dashboard for referral operations",
      ]),
